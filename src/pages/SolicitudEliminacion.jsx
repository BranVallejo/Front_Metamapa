...
const PaginaReporte = () => {
  ...
  const cardClass = "relative z-10 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border border-white/40 dark:border-white/10 rounded-3xl shadow-2xl p-8 max-w-2xl w-full mx-auto";
  const labelClass = "block text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-2 opacity-80";
  const inputClass = "w-full px-4 py-3 bg-white/50 dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-xl focus:ring-2 focus:ring-red-500/50 focus:border-red-500 transition-all outline-none text-gray-800 dark:text-gray-100 placeholder-gray-400 backdrop-blur-sm resize-none";
      ...
      <div className={cardClass}>
        ...
        <div className="mb-8 border-b border-gray-200/50 dark:border-white/10 pb-6">
          <div className="flex items-center gap-3 mb-2">
             ...
             <h1 className="text-3xl font-black text-gray-800 dark:text-white">Reportar Problema</h1>
          </div>
        ...
        <div className="bg-gray-50/80 dark:bg-white/5 rounded-xl p-4 mb-8 border border-gray-200/50 dark:border-white/5 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <span className="text-[10px] font-bold uppercase tracking-widest text-gray-400 block mb-1">Sobre el hecho</span>
                <h3 className="font-bold text-lg text-gray-800 dark:text-gray-100 line-clamp-1">{hecho?.titulo || "Hecho sin título"}</h3>
                <span className="text-xs text-gray-500 font-mono">ID: {idHecho}</span>
            </div>
        ...
        <div className="space-y-6">
          <div>
            <label className={labelClass}>Motivo del reporte <span className="text-red-500">*</span></label>
            <textarea
          ...
          <div className="flex gap-3 p-4 bg-blue-50/50 dark:bg-blue-900/10 rounded-xl border border-blue-100 dark:border-blue-900/30 text-sm text-blue-800 dark:text-blue-300">
             ...
             <p>Revisaremos tu solicitud manualmente. Si el reporte es válido, tomaremos las acciones necesarias sobre el contenido.</p>
          </div>
